...
public class Ice_Coffee extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitivity_icecoffee_detail);
        Button order  = findViewById(R.id.order);
        order.setOnClickListener(this);
        TextView names=findViewById(R.id.nameCoff);
        nameOfItem= names.getText().toString();
        TextView quantityOfItems=findViewById(R.id.icecoffee_text_view);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.order) {
            ...
            Intent intent = new Intent(Ice_Coffee.this, OrderSummary.class);
    ...
    private void display(int numbers) {
        TextView quantityTextView = (TextView) findViewById(R.id.icecoffee_text_view);
    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        switch (item.getItemId()){
            case R.id.hotbeveragemenu:
                Intent intent = new Intent(Ice_Coffee.this, Hot_Beverage.class);
                startActivity(intent);
                return true;
            case R.id.coldbeveragemenu:
                Intent intent2 = new Intent(Ice_Coffee.this, Cold_Beverage.class);
                startActivity(intent2);
                return true;
            case R.id.bakedgoodsmenu:
                Intent intent3 = new Intent(Ice_Coffee.this, Baked_Goods.class);
                startActivity(intent3);
                return true;
            case R.id.desertmenu:
                Intent intent4 = new Intent(Ice_Coffee.this, Dessert.class);
