...
public class Froyo extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView quantityOfItems=findViewById(R.id.froyo_text_view);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.order) {
            ...
            Intent intent = new Intent(Froyo.this, OrderSummary.class);
    ...
    private void display(int numbers) {
        TextView quantityTextView = (TextView) findViewById(R.id.froyo_text_view);
    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        switch (item.getItemId()){
            case R.id.hotbeveragemenu:
                Intent intent = new Intent(Froyo.this, Hot_Beverage.class);
                startActivity(intent);
                return true;
            case R.id.coldbeveragemenu:
                Intent intent2 = new Intent(Froyo.this, Cold_Beverage.class);
                startActivity(intent2);
                return true;
            case R.id.bakedgoodsmenu:
                Intent intent3 = new Intent(Froyo.this, Baked_Goods.class);
                startActivity(intent3);
                return true;
            case R.id.desertmenu:
                Intent intent4 = new Intent(Froyo.this, Dessert.class);
