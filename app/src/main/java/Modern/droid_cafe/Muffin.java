...
public class Muffin extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muffin_detail);
        Button order  = findViewById(R.id.order);
        order.setOnClickListener(this);
        TextView names=findViewById(R.id.nameCoff);
        nameOfItem= names.getText().toString();
        TextView quantityOfItems=findViewById(R.id.muffin_text_view);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.order) {
            ...
            Intent intent = new Intent(Muffin.this, OrderSummary.class);
    ...
    private void display(int numbers) {
        TextView quantityTextView = (TextView) findViewById(R.id.muffin_text_view);
    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        switch (item.getItemId()){
            case R.id.hotbeveragemenu:
                Intent intent = new Intent(Muffin.this, Hot_Beverage.class);
                startActivity(intent);
                return true;
            case R.id.coldbeveragemenu:
                Intent intent2 = new Intent(Muffin.this, Cold_Beverage.class);
                startActivity(intent2);
                return true;
            case R.id.bakedgoodsmenu:
                Intent intent3 = new Intent(Muffin.this, Baked_Goods.class);
                startActivity(intent3);
                return true;
            case R.id.desertmenu:
                Intent intent4 = new Intent(Muffin.this, Dessert.class);
