...
public class Brewed_Coffee extends AppCompatActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brewed_coffee_details);
        Button order  = findViewById(R.id.order);
        order.setOnClickListener(this);
        TextView names=findViewById(R.id.nameCoff);
        nameOfItem= names.getText().toString();
        TextView quantityOfItems=findViewById(R.id.coffee_text_view);
        ...
        if(NumberFormat.getNumberInstance().format(quantity)=="0"){
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.order) {
            ...
            Intent intent = new Intent(Brewed_Coffee.this, OrderSummary.class);
   ...
   switch (item.getItemId()){
        ...
        Intent intent = new Intent(Brewed_Coffee.this, Hot_Beverage.class);
        startActivity(intent);
        return true;
        case R.id.coldbeveragemenu:
        Intent intent2 = new Intent(Brewed_Coffee.this, Cold_Beverage.class);
        startActivity(intent2);
        return true;
       case R.id.bakedgoodsmenu:
        Intent intent3 = new Intent(Brewed_Coffee.this, Baked_Goods.class);
        startActivity(intent3);
        return true;
       case R.id.desertmenu:
        Intent intent4 = new Intent(Brewed_Coffee.this, Dessert.class);
